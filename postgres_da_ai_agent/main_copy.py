...
print_queue = queue.Queue()  # all chat responses
user_queue = queue.Queue()  # all user inputs

# Replace with your actual OpenAI API key

# delete it!!
os.environ["OPENAI_API_KEY"] = (
    "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"
)
